...
public class TFour extends Tetriminos {

	public TFour() 
	{
		super("blue");
		squareList.get(0).setPosY(0); squareList.get(0).setPosX(150);
		squareList.get(1).setPosY(-30); squareList.get(1).setPosX(90);
		squareList.get(2).setPosY(-30); squareList.get(2).setPosX(120);
		squareList.get(3).setPosY(-30); squareList.get(3).setPosX(150);
	}
		...
		try
		{
			switch (pNbr%4)
			{
				case 0:
					...
					{
						squareList.get(0).setPosY(posYr+30); squareList.get(0).setPosX(posXr+30);
						...
						squareList.get(3).setPosY(posYr); squareList.get(3).setPosX(posXr+30);
						break;
					}
					else
					{
				...
				case 1:
					if (squareList.get(0).getPosY() <= 510
						...
						&& !collision [(posXr-30)/30][(posYr-30)/30])
					{
						...
						squareList.get(2).setPosY(posYr); squareList.get(2).setPosX(posXr);
						squareList.get(3).setPosY(posYr+30); squareList.get(3).setPosX(posXr);
						break;
					}
					else
					{
	...
	public boolean canFall(boolean [][] collision) 
	{
		...
		{
			case 0 : 
				if (squareList.get(0).getPosY() < 540
			...
			case 2 : 
				if (squareList.get(2).getPosY() < 540
					&& !collision [squareList.get(3).getPosX()/30][(squareList.get(3).getPosY()+30)/30]
					&& !collision [squareList.get(2).getPosX()/30][(squareList.get(2).getPosY()+30)/30]
					&& !collision [squareList.get(1).getPosX()/30][(squareList.get(1).getPosY()+30)/30])
	...
	public void moveLeft(boolean[][] collision) 
	{
		...
		{
			case 0 :
				if (squareList.get(1).getPosX() >= 30
